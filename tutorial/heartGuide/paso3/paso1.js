        ...
        if (extendedFingers >= 4) {
          for (var i = 0; i < frame.hands.length; i++) {
            ...
            if (difPosition <= -30 && velocity < -200 && vertical < -0.9) {
              console.log("right");
              window.location.href = "../paso4/paso1.html";
            } else if (difPosition > 30 && velocity > 200 && vertical < -0.9) {
              window.location.href = "../paso2/paso1.html";
            }
          }
        } else {
          if (
            ...
            if (contador == 2000) {
              if (!visualChange) {
                ...
                visual.src = "../../../imgs/heartGuide/paso3/visualAlt.png";
                visualChange = true;
              } else {
                imageBtn.src = "../../../imgs/heartGuide/paso1/imageBtn.png";
                visual.src = "../../../imgs/heartGuide/paso3/visual.png";
                visualChange = false;
              }
            }
          } else {
